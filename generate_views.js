...
// ============================================================
// View definitions — loaded from views.json or CLI arg
// Usage: node generate_views.js [views.json path] [output directory]
// ============================================================
const isMain = require.main === module;
const jsonPath = (isMain && process.argv[2])
  ? path.resolve(process.argv[2])
  : path.join(__dirname, 'views.json');
const views = require(jsonPath);
...
const DEFAULT_AUDIT_COLS = ['modified', 'created'];
...
function generateView(view) {
  ...
  lines.push('-- ABSOLUTELY DO NOT EDIT THIS FILE. IT WAS GENERATED BY generate_views.js. DO NOT MODIFY OR REMOVE THIS COMMENT UNDER PENALTY OF CERTAIN DEATH.');
  ...
  // Base table audit columns (per-view override or default)
  const auditCols = view.auditCols || DEFAULT_AUDIT_COLS;
...
if (isMain) {
  ...
  const VIEWS_DIR = path.join(outputBase, 'VIEWS');
