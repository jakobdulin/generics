...
// ============================================================
// Table definitions — loaded from tables.json or CLI arg
// Usage: node generate_tables.js [tables.json path] [output directory]
// ============================================================
...
function generateSQL(table) {
  ...
  lines.push('-- ABSOLUTELY DO NOT EDIT THIS FILE. IT WAS GENERATED BY generate_tables.js. DO NOT MODIFY OR REMOVE THIS COMMENT UNDER PENALTY OF CERTAIN DEATH.');
...
if (require.main === module) {
  ...
  const TABLES_DIR = path.join(outputBase, 'TABLES');
